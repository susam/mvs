...
The programs available in this project consume the content of the file
[book.txt](book.txt), build an internal model and then use the model
to generate gibberish.
